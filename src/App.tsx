...
const ResponseVerificationBadge: React.FC<{ language: OriginLanguage }> = ({ language }) => <details data-testid="response-verification-details" className="origin-verification mt-1 w-full">
  <summary className="origin-muted inline-flex min-h-11 cursor-pointer list-none items-center gap-1.5 rounded-[10px] px-2 text-[13px] font-medium">
    <span aria-hidden="true">✓</span>
    <span>{language === 'en' ? 'Answer details' : '回答の詳細'}</span>
  </summary>
  <ul data-testid="response-verification-log" className="origin-surface-muted m-0 mt-1 grid gap-1 rounded-2xl p-3 text-[13px] leading-6">
