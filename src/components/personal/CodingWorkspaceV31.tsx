...
type CodingWorkspaceV31Props = { composerControls?: React.ReactNode; onProjectEvidenceChange?: (evidence: CodingProjectEvidence) => void; onRuntimeActivityChange?: (activity: OriginRuntimeActivityV31) => void };

export default function CodingWorkspaceV31({ composerControls, onProjectEvidenceChange, onRuntimeActivityChange }: CodingWorkspaceV31Props) {
  return <section aria-label="ORIGIN Coding Workspace" className="min-h-0">
    ...
    <CodingJobWorkspaceV14 composerControls={composerControls} onProjectEvidenceChange={onProjectEvidenceChange} onRuntimeActivityChange={onRuntimeActivityChange} />
  </section>;
}
