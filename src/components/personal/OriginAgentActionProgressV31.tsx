...
export default function OriginAgentActionProgressV31({ status, cancelRequested = false, busy = false, onStop }: OriginAgentActionProgressV31Props) {
  ...
  return <>
    ...
    {active && <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200 bg-white/95 p-3 shadow-lg backdrop-blur dark:border-slate-800 dark:bg-slate-950/95 md:hidden" aria-label="Agent mobile controls">
