...
export function createOriginApp(
  ...
  integrations: { mcp?: McpManagementDependencies; mcpSession?: Router; mcpAgent?: Router; mcpGithubBootstrap?: Router } = {},
): Express {
  const app = express();
  ...
  if (integrations.mcpGithubBootstrap) app.use(integrations.mcpGithubBootstrap);
