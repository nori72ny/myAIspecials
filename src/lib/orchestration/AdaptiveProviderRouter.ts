...
export function rankAdaptiveProviders(input: AdaptiveRouteInput): ProviderCandidate[] {
  ...
  const preference: Partial<Record<AITaskType, ProviderId[]>> = {
    implementation: ['google-ai-studio', 'groq', 'openrouter'], test: ['google-ai-studio', 'groq', 'openrouter'],
    documentation: ['google-ai-studio', 'openrouter', 'groq'], research: ['openrouter', 'google-ai-studio', 'groq'],
    security: ['google-ai-studio', 'openrouter', 'groq'], ux: ['google-ai-studio', 'openrouter', 'groq'],
    review: ['google-ai-studio', 'openrouter', 'groq'], operations: ['groq', 'google-ai-studio', 'openrouter'],
    architecture: ['google-ai-studio', 'openrouter', 'groq'], 'current-information': ['openrouter', 'google-ai-studio', 'groq'],
  };
