...
export const DEFAULT_ORIGIN_FREE_MODEL_CATALOG: readonly OriginFreeModelEvidence[] = [
  {
    ...
    verifiedAt: "2026-08-30T21:09:07.588Z",
    reviewAfter: "2026-09-09T21:09:07.587Z",
    sourceUrl: ORIGIN_OPENROUTER_FREE_MODEL_SOURCE,
    sourceDescription: "OpenRouter's official /api/v1/models response reported pricing.prompt and pricing.completion as exactly zero for this model ID at verification time. This evidence expires on 2026-09-09T21:09:07.587Z. Runtime still requires exact served-model identity, fixed-route evidence, denied data collection, and reported usage cost of zero before returning an answer.",
  },
] as const;
