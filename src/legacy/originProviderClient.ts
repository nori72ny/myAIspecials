...
function evidence(request: OriginProviderExecutionRequest, servedModel: string): OriginProviderRoutingEvidence { return { requestedModel: request.plan.modelId, servedModel, strategy: "adaptive-primary", provider: "OpenRouter", attempt: 1, fallbackUsed: false }; }
