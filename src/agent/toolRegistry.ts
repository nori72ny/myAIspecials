...
export type ToolName = 'code_interpreter' | 'document_generator' | 'web_search_grounding' | 'image_prompt_compiler' | 'repository_explorer' | 'file_reader';
export type ToolParams = Record<string, unknown>;
export type ToolResult = { ok: boolean; tool: ToolName; artifact?: string; message: string };

type ToolDefinition = { name: ToolName; capability: AgentCapability; description: string; sideEffects: 'none'; requiresApproval: true; execute: (params: ToolParams) => Promise<ToolResult> };
