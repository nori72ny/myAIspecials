  ...
  return messages.map((message, index) => {
    ...
    if (sourceImage && typeof sourceImage === 'object') {
      ...
      const validVisualProvenance = sourceImage.visualBrainVersion === 'visual-brain-v1'
        ...
        && sourceImage.sourceCriticVersion === 'raster-structural-critic-v1'
        && typeof sourceImage.sourceQualityScore === 'number'
        && Number.isInteger(sourceImage.sourceQualityScore)
        && sourceImage.sourceQualityScore >= 0
        && sourceImage.sourceQualityScore <= 100
        && (sourceImage.visionCriticState === undefined || sourceImage.visionCriticState === 'passed' || sourceImage.visionCriticState === 'unavailable')
        && (sourceImage.visionCriticVersion === undefined || sourceImage.visionCriticVersion === 'raster-vision-critic-v1')
        && (sourceImage.visionCriticModel === undefined || typeof sourceImage.visionCriticModel === 'string' && sourceImage.visionCriticModel.length > 0 && sourceImage.visionCriticModel.length <= 180)
        && (sourceImage.visionQualityScore === undefined || typeof sourceImage.visionQualityScore === 'number' && Number.isInteger(sourceImage.visionQualityScore) && sourceImage.visionQualityScore >= 0 && sourceImage.visionQualityScore <= 100)
        && (sourceImage.visionCriticState !== 'passed' || sourceImage.visionCriticVersion === 'raster-vision-critic-v1' && typeof sourceImage.visionCriticModel === 'string' && typeof sourceImage.visionQualityScore === 'number');
      if (validMime && validAsset && sourceImage.providerId === 'pollinations-zero-cost'
        ...
        image = {
          ...
          visionCriticState: sourceImage.visionCriticState,
          visionCriticVersion: sourceImage.visionCriticVersion,
          visionCriticModel: sourceImage.visionCriticModel,
          visionQualityScore: sourceImage.visionQualityScore === undefined ? undefined : Number(sourceImage.visionQualityScore),
