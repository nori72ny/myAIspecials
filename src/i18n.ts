...
export const TRANSLATIONS: Record<OriginLanguage, Translation> = {
  ja: {
    ...
    exitFullscreen: '縮小',
    close: '閉じる',
    closeWorkspace: '作成物を閉じる',
    showCode: 'コードを表示',
    showPreview: 'プレビューを表示',
    copyArtifact: '作成物をコピー',
    downloadArtifact: '作成物を保存',
    ...
    starterCards: [
      ...
      { title: '文章にする', subtitle: '作成物', description: 'メモを、伝わる文章・コードへ整える', prompt: '以下の内容を、用途に合った完成度の高い文章や作成物に整えてください:\n' },
