...
export const TRANSLATIONS: Record<OriginLanguage, Translation> = {
  ja: {
    ...
    homeHeading: '何をしたいですか？',
    homeDescription: '考え途中でも、そのまま入力してください。必要な調査・整理・作成方法をORIGINが判断します。',
    startWith: '始め方を選ぶ',
    freeOnlyNotice: '無料AIのみ・有料AIへの自動切替なし',
    starterCards: [
  ...
  en: {
    ...
    chatPlaceholder: 'Describe the decision, outcome, or deliverable you need… (⌘+Enter to send)',
    homePlaceholder: 'Describe the decision, outcome, or deliverable you need',
    ...
    homeHeading: 'What do you want to do?',
    homeDescription: 'Start with an unfinished thought. ORIGIN will decide how to research, organize, or create the next useful result.',
